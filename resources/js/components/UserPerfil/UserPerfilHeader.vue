        ...
        <div class="header-container h-100">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="row">
                        <div class="col-4">
                            <span>{{ user.promotion_purchase_count }}</span>
                            <img src="/assets/images/perfil_teacher/cursos.svg" alt="">
                            <p>Cursos<br/> inscritos</p>
                        </div>
                        <div class="col-4">
                            <span>{{ user.favourites_courses_count }}</span>
                            <img src="/assets/images/perfil_teacher/ventas.svg" alt="">
                            <p>Cursos<br/> favoritos</p>
                        </div>
                        <div class="col-4">
                            <span>{{ user.coupons_promotions_promotion_purchase_count }}</span>
                            <img src="/assets/images/perfil_teacher/shape.svg" alt="">
                            <p>Cursos<br/> compartidos</p>
                        </div>
                    </div>
                </div>
            </div>
