  ...
  <div class="form-categories">
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <label for="category" class="mb-0 pl-4 h7-txt">Categoria</label>
                <div class="pl-4 pt-0 pr-4">
                    <select class="input-box pb-2" name="category" :id="idCategory" required="" v-model="categories" @change="changeSelect($event)">
                        ...
                        <option value="LENGUA">Lengua, lectura y escritura</option>
                        <option value="rs">Redes Sociales</option>
                        <option value="code">Programación</option>
                        <option value="robot">Robótica</option>
                        <option value="game">Creación Videojuegos</option>
                        <option value="design">Diseño Digital</option>
        ...
        <div class="row mx-auto mt-4">
            <div class="col-12 col-sm p4-txt text-left">
                Al enviar la información, aceptas la <a href="/es/politica-de-privacidad">Política de Privacidad</a> <br> y las
                <a href="/es/terminos-y-condiciones">Condiciones del Servicio</a>
            </div>
