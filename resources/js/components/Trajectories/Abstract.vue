...
<div class="container text-center mt-100 mb-100">
  ...
  <div class="h7-txt-light mt-8">
    ...
    <p>Estos cursos tienen una duración <span>anual</span>, desde principios de Octubre 
    hasta finales de Junio <br> adaptados al <span>nivel</span> y <span>edad</span> de cada alumno. Los cursos forman parte de <span>trayectorias de</span><br> <span>aprendizaje</span> que consolidan una línea de conocimientos y habilidades, de forma que <br> el alumno se encontrará preparado para asumir los retos del futuro.</p>
   </div>
</div>
</template>
