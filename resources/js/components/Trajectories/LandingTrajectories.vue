...
<script>
import TechHeaderTrajectories from '../Trajectories/TechHeaderTrajectories.vue'
import Abstract from '../Trajectories/Abstract.vue'
import Categories from '../Trajectories/Categories.vue'

export default {
 components:{
   TechHeaderTrajectories,
   Abstract,
   Categories
 }
}
