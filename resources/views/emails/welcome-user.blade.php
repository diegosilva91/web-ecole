...
<div class="es-wrapper-color" style="width: 100%">
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="background-color: white">
                                ...
                                <tr>
                                    <td class="es-p40t es-p35r es-p35l" align="left">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="530" valign="top" align="center">
                                                    <strong><p class="" style="width: 577px; font-family: Poppins; font-size: 19px;font-weight: 600; font-stretch: normal; font-style: normal; line-height: normal;letter-spacing: normal;text-align: center;color: #262626;margin-bottom: 50px;margin-top: 35px;">La primera plataforma en España en ofrecer cursos extraescolares online en vivo para niñ@s de entre 3 y 18 años.</p></strong>
                                                </td>
                                            </tr>
                                        </table>
                                        <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr><td><table style="margin-top: 70px"class="es-content-body rectangle-steps" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                    <tbody><tr>
                        <td class="es-p40t es-p35r es-p35l" align="left">
                            <table width="100%" cellspacing="0" cellpadding="0">
                                <tbody><tr>
                                                    ...
                                                    <div class="steps-content" style="margin-top: 36px">
                                                        <table style="float: left; margin-bottom: 71px">
                                                            <tr>
                                                                ...
                                                                <td class="step-tr-content"><h2 style="font-family: Poppins; font-size:21px; color:#803a91;text-align: left">Descubre Nuestros cursos</h2>Personaliza la educación de tus hij@s explorando nuestro amplio catálogo de cursos. Fomenta desde casa la educación de tus hij@s y despierta el "genio" lleva dentro.</td>
                                                            </tr><tr>
                                                                <td><span class="step-number">2</span></td>
                                                                <td class="step-tr-content"><h2 style="font-family: Poppins; font-size:21px; color:#803a91;text-align: left">Revisa tu disponibilidad</h2>Selecciona fecha y hora del curso que te convenga y reserva tu clase con
                                                                    un solo click. ¿No ves un horario que te funcione? ¡Solicita otro horario!</td>
                                                            </tr><tr>
                                                                <td><span class="step-number">3</span></td>
                                                                <td class="step-tr-content"><h2 style="font-family: Poppins; font-size:21px; color:#803a91;text-align: left">Disfruta de nuestras clases en vivo</h2>Explora nuestras clases online y en vivo con grupos reducidos de alumn@s. Las clases serán grabadas para garantizar la seguridad de todos.</td>
                    ...
                    <tr><td><table style="margin-top: 60px"class="es-content-body rectangle-cards" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                        <tbody><tr>
        ...
        <tr><td><table class="es-content-body rectangle-steps" style="margin-top:70px; background-color: #803a91; width: 100%" width="600" cellspacing="0" cellpadding="0" bgcolor="white" align="center">
                    <tbody><tr>
