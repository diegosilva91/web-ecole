                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td class="es-p10b" align="center">
                                                                <p class="hola">¡Es el momento de despertar al genio<br>
                                                                    que llevas dentro @isset($user){{$user->name}}! @endisset! 🎉<br>
                                                                    Disfruta aprendiendo con uno de <br>
                                                                    nuestros cursos. ¡Te esperamos! 🚀</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
