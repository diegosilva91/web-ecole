...
<div class="es-wrapper-color" style="width: 100%">
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="background-color: white">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td class="es-p10b" align="center">
                                                                <p class="hola">¡Te echamos de menos @isset($user){{$user->name}}! @endisset! 🎉<br>
                                                                Explora nuestros cursos y descubre cual<br> se adapta mejor a tus intereses<br> y disponibilidad 🚀</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
        ...
        <tr><td><table style="margin-top: 70px"class="es-content-body rectangle-cards" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                    <tbody><tr>
                                ...
                                <tbody>
                                    ...
                                    <td width="530" valign="top" align="center">
                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                            <tbody><tr>
                                                <td class="es-p10b" align="center">
                                                    <span class="steps-text-header" align="center">Conócenos mejor</span>
