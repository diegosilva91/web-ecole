                    ...
                    <tr>
                        <td align="center">
                            <table class="es-header-body" style="background-color: #044767;" width="600"
                                ...
                                <tr>
                                    <td class="es-p35t es-p35b es-p35r es-p35l" align="center">
                                        <table class="" cellspacing="0" cellpadding="0" align="center">
                                            <tr>
                                                <td class="es-m-p0r es-m-p20b" width="100%" valign="top"
                                                    align="center">

                                                    <img src={{asset("assets/images/logo-small-white.png")}} alt=""
                                                         width="140px">
                                ...
                                <tr>
                                    <td class="es-p40t es-p35r es-p35l" align="left">
                                            ...
                                            <tr>
                                                <td width="530" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td class="es-p10b" align="center">
                                                                <h2>{{$promotionPurchasePayment->payment_status_error}}</h2>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="530" valign="top" align="center">
                                                    <img src="{{ asset($course->cover_image) }}" alt="" width="50%">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                                            ...
                                                            <td class="es-p10t es-p10b es-p10r es-p10l"
                                                                ...
                                                                <table style="width: 500px;" class="cke_show_border"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding: 5px 0;"
                                                                            align="left">
                                                                            <p>{{$promotionPurchasePayment->payment_method}}</p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="padding: 5px 10px 5px 0;" width="60%"
                                                                            align="left">
                                                                            <p>Tiempo por sesion:</p>
                                                                        </td>
                                                                        <td style="padding: 5px 0;"
                                                                            align="left">
                                                                ...
                                                                <table style="width: 500px;" class="cke_show_border"
                                                                    ...
                                                                    @isset($course->discount)
                                                                        <tr>
                                                                            ...
                                                                            <td width="20%">
                                                                                <h4>{{$course->price_total}} €</h4>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="80%">
                                                                                <h4>DESCUENTO {{(int)$course->discount}} %</h4>
                                                                            </td>
                                                                            <td width="20%">
                                                                                <h4>{{$course->price_total*($course->discount/100)}} €</h4>
                                                                            </td>
                                                                        </tr>
                                                                        @isset($promotionPurchasePayment->coupon_id)
                                                                            <tr>
                                                                                <td width="80%">
                                                                                    <h4>CÓDIGO DESCUENTO{{$promotionPurchasePayment->coupon()->discount}} {{$promotionPurchasePayment->coupon()->type}}</h4>
                                                                                </td>
                                                                                <td width="20%">
                                                                                    <h4>{{$promotionPurchasePayment->coupon_discount}} €</h4>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="80%">
                                                                                ...
                                                                                <td width="20%">
                                                                                    <h4>{{$promotionPurchasePayment->total_price}} €</h4>
                                                                                </td>
                                                                            </tr>
                                                                        @else
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%">
                                                                                    <h4>{{$course->price_total - $course->price_total*($course->discount/100)}} €</h4>
                                                                                </td>
                                                                            </tr>
                                                                        @endisset
                                                                    @else
