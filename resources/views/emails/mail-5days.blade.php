                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td class="es-p10b" align="center">
                                                                <p class="hola">Hola @isset($user){{$user->name}}! @endisset  🎉 </p>
                                                                <p class="hola">¿Todavía no has decidido
                                                                <br>con qué curso empezar? 🚀</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                ...
                                <tbody>
                                    ...
                                    <td width="530" valign="top" align="center">
                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                            <tbody><tr>
                                                <td class="es-p10b" align="center">
                                                    <span class="steps-text-header" align="center">¡Descubre las últimas novedades<br> en nuestras redes sociales!</span>
