@php
    $seo_title = 'Cursos de Programación Online - Mi-empresa';
    ...
    <div class="container mt-50 mb-100 text-justify">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="h8-txt-light">
                    ...
                    <p>En <a class="blue-title" href="/es">Mi-empresa</a> lo sabemos, por eso hemos creado esta <b>categoría específica para todos nuestros cursos de programación</b>. Aquí encontrarás todos los cursos que podemos ofrecerte para que tus hij@s puedan empezar a sentar las bases de estos conocimientos.</p>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="h8-txt-light">
                    <p>En Mi-empresa tenemos por <b>objetivo ayudar a los alumnos a adoptar y desarrollar nuevas competencias del siglo XXI</b>. Además, nos esforzamos para que en todos nuestros cursos se fomenten y aprendan 3 conceptos básicos para llevar a cabo cualquier tipo de proyecto:</p>
                    <ul>
